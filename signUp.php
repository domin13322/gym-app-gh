...
Login
<br>
<input type="text" name="loginR" id="loginR" class="signInInput" required>
<br>
e-mail
<br>
...
Password
<br>
<input type="password" name="passwordR" id="passwordR" class="signInInput" required>
<br>
Repeat password
<br>
<input type="password" name="passwordR2" id="passwordR2" class="signInInput" required>
<br>
...
<br>
<?php include "displayRegisterError.php"; ?>
</form>
</div>
<footer id="footer">
   Copyright 2022 &copy
