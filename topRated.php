...
<body background="img/pexels-victor-freitas-685530.jpg">
    <div id="forumContainer">
        ...
        <br>
        <div class="content">
            <h2 style="color:darkred;">Top rated qestions</h2>
            <?php
                if($result=$connect->query("SELECT user,title,questionDate,questionId, answers,raiting FROM forum ORDER BY raiting DESC")){
